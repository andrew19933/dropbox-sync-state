...
; My small blurb to get the values associated to the Dropbox icon in SysTray
; test := TrayIcon_GetInfo()
; for i,j in test[1] ; assumed Dropbox icon is first in SysTray
; MsgBox, System tray icon 1 has %i% = %j%